...
import {freetTypeRouter} from '../server/freetType/router';
import {fullStoryRouter} from '../server/fullStory/router';
...
app.use('/api/freetTypes', freetTypeRouter);
app.use('/api/fullStories', fullStoryRouter);
